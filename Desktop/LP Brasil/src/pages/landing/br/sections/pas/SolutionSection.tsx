        ...
        <div className="mx-auto max-w-7xl">
            ...
            {t.solution.pillars.map((pillar, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-center text-witfy-600">
                    {pillar.title}
                  </h3>
          ...
          <div className="bg-gradient-to-r from-witfy-100 to-purple-100 dark:from-witfy-900/20 dark:to-purple-900/20 rounded-2xl p-8 md:p-12">
            <div className="text-center mb-8">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">{t.solution.proof.title}</h3>
              <div className="flex items-center justify-center gap-4 mb-4">
                <span className="text-6xl font-bold text-witfy-600">{t.solution.proof.stat}</span>
                <span className="text-xl text-muted-foreground">{t.solution.proof.description}</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="font-semibold text-lg">{t.solution.proof.author}</p>
                <p className="text-muted-foreground">{t.solution.proof.role}</p>
              </div>
            </div>
          </div>
        </div>
