        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-destructive">
                {t.agitate.title}
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {t.agitate.painPoints.map((point, index) => (
                <Card
                  key={index}
                  className="border-destructive/20 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/10 dark:to-orange-900/10"
                >
